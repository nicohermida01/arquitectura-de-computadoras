.data
msjIngreso1: .asciiz "Ingrese una clave de 4 caracteres ("
msjIngreso2: .asciiz " intentos restantes)"
msjCorrecto: .asciiz "Clave correcta: acceso permitido"
msjIncorrecto: .asciiz "Clave incorrecta"
msjFin: .asciiz "No tienes más intentos"
LF: .byte 0x0A
intentos: .word 5
clave: .ascii "boca"
input: .space 4
...
inicio: daddi $t2, $zero, msjIngreso1
sd $t2, 0($t1)
daddi $t2, $zero, 4
sd $t2, 0($t0)
ld $t2, intentos($zero)
